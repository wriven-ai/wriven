      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-12 border-t border-b border-brand-border flex flex-col lg:flex-row items-center justify-between gap-12 text-left" id="pricing-banner-card">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0 w-full sm:w-auto" id="pricing-banner-buttons">
            <Link
              href="/pricing"
              className="w-full sm:w-auto inline-flex items-center justify-center bg-brand-surface text-text-secondary border border-brand-border hover:border-brand-border-button font-mono font-bold text-xs uppercase tracking-wider px-6 py-4 rounded-lg transition-all"
            ...
            <Link
              href="/pricing"
              className="w-full sm:w-auto inline-flex items-center justify-center bg-brand-accent hover:bg-brand-accent-hover text-white font-mono font-bold text-xs uppercase tracking-wider px-6 py-4 rounded-lg transition-all"
