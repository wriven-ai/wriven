        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-6" id="testimonials-list">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-brand-border/70">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-brand-surface-soft border border-brand-border-button flex items-center justify-center font-mono text-sm font-bold text-brand-accent">
                    ES
                  </div>
                  <div>
                    <div className="text-sm font-bold text-text-primary">Evelyn Sterling</div>
                    <div className="text-sm text-text-secondary">VP of Product, ArchDaily Studio</div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-brand-border/70">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-brand-surface-soft border border-brand-border-button flex items-center justify-center font-mono text-sm font-bold text-brand-secondary">
                    MC
                  </div>
                  <div>
                    <div className="text-sm font-bold text-text-primary">Marcus Chen</div>
                    <div className="text-sm text-text-secondary">Design Director, Monocle Reader</div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-brand-border/70">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-text-primary">Dr. Elena Rostova</div>
                    <div className="text-sm text-text-secondary">Infrastructure Architect, NexaCorp</div>
                  </div>
                </div>
